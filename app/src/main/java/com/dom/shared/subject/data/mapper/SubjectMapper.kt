...
fun Subject.toDto() = SubjectDto(id, name, note, price, amount, amountTypeId, private)

fun SubjectDto.toEntity() = Subject(id, name, note, price, amount, amountTypeId, private)
